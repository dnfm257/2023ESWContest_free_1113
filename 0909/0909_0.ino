...
void CP()
{
  if(IN==LOW) //입구센서감지
  {
    ...
    i++;
    delay(40); //측정오차 보정을 위해 20->40(0909)
    INTime = millis();
    Serial.println("i++");
    echo1();
